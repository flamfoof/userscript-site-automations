// ==UserScript==
// @name		Staging Admin Movie Delete Select Specific Source
// @include		https://env.company.com/admin/guide/movie/*
// @version  1
// @grant    none
// ==/UserScript==
...
window.addEventListener('load', function() {
  	var source = "tubi"
    var rows = document.querySelectorAll('tr:has(.field-source select[name*="Movie_links-"])');
    rows.forEach(row => {
