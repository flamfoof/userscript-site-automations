...
// @author       Flamfoof
// @match        https://freecast.atlassian.net/browse/STVI*
// @grant        none
// ==/UserScript==
		...
		if (secondChild && secondChild.innerText === defaultValue) {
			...
			if (action == "ajax") {
				let response = await fetch(
					"https://freecast.atlassian.net/secure/AjaxIssueAction.jspa?decorator=none",
					{
						credentials: "include",
						headers: {
							"User-Agent":
						...
						referrer: "https://freecast.atlassian.net/browse/STVI-6044",
