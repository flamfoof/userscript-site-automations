// ==UserScript==
// @name		Freecast QA Site Print Backend Shortcut
// @include		*://watchqa.freecast.com/guide/*/info/*
// @include		*://watchqa.freecast.com/guide/vod/*/*
// @version  1
// @grant    none
// ==/UserScript==
...
function getContentData() {
	...
	for (let resource of resources) {
		if (
			resource.name.includes("guide/api/v1/watch-freecast-com-qa/web/") ||
			resource.name.includes("guide/api/v2/watch-freecast-com-qa/web/") ||
			resource.name.includes("guide/api/v4/watch-freecast-com-qa/web/vod/")
		) {
			...
			if (!currRequest) {
          	...
          	console.log("Getting content")
						...
						if (!isVod) {
							adminDashboardLink = `https://stvqa.freecast.com/admin/guide/${mediaType == "movies" ? "movie" : "show"}/${
								content.id
							}`;
							console.log(`Admin Dashboard Link: ${adminDashboardLink}`);
						} else {
							adminDashboardLink = `https://stvqa.freecast.com/admin/guide/${
