// ==UserScript==
// @name		Admin Episode Deeplinks Series Print
...
window.addEventListener('load', async function() {
    ...
    let seasonId = document.getElementById("id_season").value
    ...
    if(prevSeriesLink) {
        ...
        seriesTitleElement.innerHTML += `<br><a href="${originLink}/admin/guide/show/?name=${seriesTitle}">[Search Link]</a>`
    }
    x.length -= 1;
