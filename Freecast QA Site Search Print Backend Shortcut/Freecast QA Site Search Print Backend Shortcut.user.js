// ==UserScript==
// @name		Freecast QA Site Search Print Backend Shortcut
// @include		*://watchqa.freecast.com/ai-search/search-results?prompt=*
// @version  	1
// @grant		addStyle
...
function getContentData() {
	...
	for (let i = 0; i < contentPanel.length; i++) {
		...
		adminDashboardLink = `https://stvqa.freecast.com/admin/guide/${isVod}${currentMediaTargetClick == "movies" ? "movie" : "show"}/${
			targetResource[i].id
		}`;
